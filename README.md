...
Analysis of customer purchase frequency and spending behavior

Product-wise and category-wise sales analysis

Identification of repeat and high-value customers

Detection of inactive customers to assess potential churn

Visualization of key metrics and trends using Power BI

Individual Contribution

Executed and thoroughly understood all SQL queries used in the analysis

Modified queries to explore customer frequency, spending patterns, and inactivity

Performed data cleaning and exploratory analysis using Python

Designed and interpreted Power BI dashboards to communicate insights

Developed an understanding of how customer data supports business decisions

Key Business Insights

A relatively small segment of customers contributes significantly to total revenue

Repeat customers exhibit higher average spending compared to one-time buyers
...
Practical application of SQL for customer and sales analysis

Experience in data cleaning and exploratory data analysis using Python

Hands-on exposure to dashboard design and data storytelling with Power BI

Improved ability to interpret customer behavior from a business perspective
